...
|:--|:--|:--|:--|
| `hardware/eda/schematic.pdf` | Export supplied 2026-07-18 | PDF metadata removed from a copy | Historical schematic export. The visible peripheral pins are consistent with the current README pin table; no current hardware re-test was run. |
